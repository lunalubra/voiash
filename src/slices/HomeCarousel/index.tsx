  ...
  return (
    ...
    >
      <div className="w-full max-w-screen-xl h-[500px] m-auto py-[72px] px-10 md:px-14 flex flex-col items-center md:items-start text-center md:text-left">
        ...
        <div className="w-min font-playfair text-brand-beige-200 text-xl px-8 py-4 md:py-3 rounded-full border border-brand-beige-200 bg-black bg-opacity-40 mt-5 md:mt-4">
